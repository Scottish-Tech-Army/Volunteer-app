...
- The app crashes with an opensslErrorStack: (error: 03000086)
 ...
 - The app crashed with the error "Metro has encountered an error: While trying to resolve module '@react-native/normaliza-color' from the file 'C:\\path\\to\\Volunteer-app\\app\\node_modules\\deprecated-react-native-prop-types\\DeprecatedColorPropType.js', the package 'C:\path\to\Volunteer-App\\app\\node_modules\\@react-native\\normaliza-color\\package.json' was successfully found. However, this package itself specifies a 'main' module field that could not be resolved.
    > Cd into /app and run: npm i @react-native/normalize-color.
