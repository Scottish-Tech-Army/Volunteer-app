...
describe('Test the events api', () => {
  ...
  test('GET single event should respond successfully', async () => {
    ...
    // Run test
    const response = await get(`http://localhost:3000/events/${fakeEvent.id}`);
    requestMock.done();
  ...
  test('GET past events should respond successfully', async () => {
    ...
    // Run test
    const response = await get('http://localhost:3000/events/scheduled/past');
    requestMock.done();
  ...
  test('GET upcoming events should respond successfully', async () => {
    ...
    // Run test
    const response = await get('http://localhost:3000/events/scheduled/upcoming');
    requestMock.done();
  ...
  test('getScheduledEventsHandler gets past events and returns a response', async () => {
    ...
    const fakePastEvents = fakeEventAirTableRecords(fakePastEventsCount, 'past');
    const fakeFutureEvents = fakeEventAirTableRecords(fakeFutureEventsCount, 'future');
